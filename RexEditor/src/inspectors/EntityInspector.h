...
namespace RexEditor
{
	...
	{
	public:
		inline static void InspectEntity([[maybe_unused]] float deltaTime, RexEngine::Entity entity)
		{
	...
	template<>
	inline void EntityInspector::DrawComponent<RexEngine::MeshRendererComponent>(RexEngine::Entity entity)
	{
	...
	template<>
	inline void EntityInspector::DrawComponent<RexEngine::CameraComponent>(RexEngine::Entity entity)
	{
	...
	template<>
	inline void EntityInspector::DrawComponent<RexEngine::SkyboxComponent>(RexEngine::Entity entity)
	{
	...
	template<>
	inline void EntityInspector::DrawComponent<RexEngine::PointLightComponent>(RexEngine::Entity entity)
	{
	...
	template<>
	inline void EntityInspector::DrawComponent<RexEngine::DirectionalLightComponent>(RexEngine::Entity entity)
	{
	...
	template<>
	inline void EntityInspector::DrawComponent<RexEngine::SpotLightComponent>(RexEngine::Entity entity)
	{
